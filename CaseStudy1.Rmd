...
This report investigates the potential differences in birth weight between babies born to mothers who smoked during pregnancy and those who did not. Epidemiological research has consistently linked smoking during pregnancy to low birth weights and preterm birth. Birth weight can be an indicator of a newborn's health, with lower birth weights associated with an increased risk of infant mortality. This study seeks to quantify the effects of maternal smoking on infant birth weight through statistical analysis using data from the Child Health and Development Studies (CHDS) dataset. 
...
- Some of the data may have been self reported (considering some of the unreasonable values in the dataset that were Section 2.1 Data Processing) which can lead to some biases.

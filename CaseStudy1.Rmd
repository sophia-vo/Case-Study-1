...
However, there are several limitations to this analysis. The CHDS dataset is not a simple random sample, collected from mothers enrolled in the Kaiser Health Plan in Oakland, California, between 1960 and 1967. The results of this study may not be generalizable to other populations due to this bias. During data cleaning, outliers and invalid data values were removed to avoid skewing the data results. However, there remains the possibility of legitimate outliers that could provide other insight. 
